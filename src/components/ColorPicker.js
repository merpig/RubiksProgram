    ...
    return (
        <Row className="cp-container" style={{height:"98%",width:"100%", overflowX:"hidden!important",overflowY:"hidden!important",margin:"0px"}}>
            ...
            <Col style={{width:"50%",margin:0}}>
                <button id="ColorPicker" data="Color Picker" onClick={optionClick} className="cpButton activeMenu" style={{float:"left",width:"25%",marginLeft:"4px"}}>Exit</button>
                {props.colorPicked==="yellow"||props.colorPicked==="white"?
                    <div style={{backgroundColor:props.colorPicked, borderRadius: ".25rem",height:"22.5%",fontSize:"1.5rem",color:"#343a40",width:"70%",margin:"auto",border:"1px solid #343a40",float:"right",marginRight:"4px"}}>Color</div>:
                    <div style={{backgroundColor:props.colorPicked, borderRadius: ".25rem",height:"22.5%",fontSize:"1.5rem",color:"lightgrey",width:"70%",margin:"auto",border:"1px solid #343a40",float:"right",marginRight:"4px"}}>Color</div>
                }
