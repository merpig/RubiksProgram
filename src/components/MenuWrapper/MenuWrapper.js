...
class Menu extends Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        ...
        //if(this.props.state.currentFunc==="Scrambling"&&this.props.state.currentFunc===nextProps.state.currentFunc) return false;
        if(
            ...
            return false;
        //if(this.props.state.currentFunc==="Solving"&&this.props.state.moveSet===nextProps.state.moveSet&&this.props.state.playOne===false&&this.props.state.autoPlay===false) return false;
        console.log(this.props.state.activeMenu,nextProps.state.activeMenu);
        return true;
    }
    render(){
