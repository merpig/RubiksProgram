        ...
        {close => (
          <div style={{zIndex:"100",width:"100%",height:"100%"}}>
            ...
            <div style={{zIndex:"102",width:"max-content",margin:"auto",transform:"translateX(-50%)",padding:"8px"}} className="popupDiv">
              ...
              <div style={{backgroundColor:"rgba(0,0,0,.8)",marginTop:"0",color:"lightgrey",fontSize:"1rem",textAlign:"center",borderRadius:".25rem",padding:"8px"}}>
                ...
                <hr style={{backgroundColor:"lightgray",width:"60%"}}></hr>
                <div style={{marginBottom: "0",paddingBottom:"1rem"}}>Author: Sasha Peters <br></br> <a target="#" href="https://www.github.com/merpig"><i className="fa fa-github" style={{fontSize:"36px",marginRight:"10px"}}></i></a><a target="#" href="https://www.linkedin.com/in/alexandr-sasha-peters-8a2489168/"><i className="fa fa-linkedin" style={{fontSize:"36px"}}></i></a></div>
